/*
 ...
 Remember to run "npm i" in this directory BEFORE to try to run this code (with "node proximity.js")
 */
...
board.on("ready", function() {
  ...
  let proximity =  new five.Proximity({
      controller: "HCSR04",
      pin: pins.d1  // connect the TRIG *AND* ECHO to d1 ***YES both pins on the sensor
    });
